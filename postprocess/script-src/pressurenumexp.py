...
cycl=1
if cycl==0 :
    file2 = '../results/I-II-C0/postProcessing/volavg.csv'
    #file5 = '../results/III-V-C0/postProcessing/volavg.csv'
    file5 = '../results/volRegion.dat'
    file6 = '../results/volRegion0B.dat'
    file3 = '../preprocess/BIC-I-II-C0/BC-mfr.csv'
    file4 = '../preprocess/BIC-III-V-C0/BC-mfr.csv'
    xmin,xmax=0,1
    ymin,ymax=0.1,0.5
if cycl==1 :
#    file2 = '../results/20200510_1249/postProcessing/volavg.csv'
    file2 = 'pmoy2.csv'
    file5 = '../results/20200514_1420/postProcessing/volumeAverage/0.155/volRegion.dat'
    file6 = '../results/volRegion.dat'
#    file5 = '../results/III-V-C0/postProcessing/volavg.csv'
    file3 = '../preprocess/BIC-I-II-C1/BC-mfr.csv'
    file4 = '../preprocess/BIC-III-V-C1/BC-mfr.csv'
    xmin,xmax=1,2
    ymin,ymax=0.1,1.8
if cycl==2 :
    file2 = '../results/20200510_1249/postProcessing/volavg.csv'
    file5 = '../results/20200510_2058/postProcessing/volavg.csv'
    file3 = '../preprocess/BIC-I-II-C0/BC-mfr.csv'
    file4 = '../preprocess/BIC-III-V-C0/BC-mfr.csv'
if cycl==3 :
    file2 = '../results/20200510_1249/postProcessing/volavg.csv'
...
xi5 = reader3(file5) # Call the subroutine
xi6 = reader3(file6) # Call the subroutine
...
plt.plot(varx5,vary5,color='green',linewidth=1.5)
plt.plot(varx6,vary6,color='green',linewidth=1.5)
plt.plot(varx3,vary3,color='darkred',linewidth=1.5,label='0D')
plt.plot(varx4,vary4,color='darkred',linewidth=1.5)
plt.grid()
